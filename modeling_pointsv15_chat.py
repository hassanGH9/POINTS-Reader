...
class POINTSV15ChatModel(PreTrainedModel, GenerationMixin):
    ...
    def get_input_embeddings(self):
        """Get the input embeddings layer from the LLM."""
        return self.llm.get_input_embeddings()

    def set_input_embeddings(self, value):
        """Set the input embeddings layer for the LLM."""
        self.llm.set_input_embeddings(value)

    def get_output_embeddings(self):
        """Get the output embeddings layer from the LLM."""
        return self.llm.get_output_embeddings()

    def set_output_embeddings(self, new_embeddings):
        """Set the output embeddings layer for the LLM."""
